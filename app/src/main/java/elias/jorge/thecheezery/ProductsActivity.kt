...
class ProductsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var productViews: ListView = findViewById(R.id.listViewProductos)
        var adapter: ProductAdapter = ProductAdapter(this, coldDrinks)

        productViews.adapter = adapter
    ...
    private class ProductAdapter:BaseAdapter{
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            val textViewProductPrice = view.findViewById<TextView>(R.id.textViewProductPrice)

            imageViewProduct.setImageResource(product.image)
            textViewProductName.text = product.name
            textViewProductDescription.text = product.desc
